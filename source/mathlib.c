...
void TranslationMatrix (const vec3_t trans, float matrix[3][4] )
{
	matrix[3][0] = trans[0];
	matrix[3][1] = trans[1];
	matrix[3][2] = trans[2];
...
/* HAMMER */
void MultiplyMatrix(float MatrixIn1[4][4], float MatrixIn2[4][4], float MatrixOut[4][4])
{
	int nRow;
	int nCol;
	int i;
...
void RotateX(float Matrix[4][4], float fDegrees)
{
...
void RotateY(float Matrix[4][4], float fDegrees)
{
...
void RotateZ(float Matrix[4][4], float fDegrees)
{
	float Temp00, Temp10, Temp20, Temp30;
	float Temp01, Temp11, Temp21, Temp31;
